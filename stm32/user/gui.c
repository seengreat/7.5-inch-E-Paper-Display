...
parameter:
    x1 £ºStarting Xpoint point coordinates
    y1 £ºStarting Ypoint point coordinates
    x2   £ºEnd point Xpoint coordinate
    y2   £ºEnd point Ypoint coordinate
...
parameter:
    x1 £ºRectangular  Starting Xpoint point coordinates
    y1 £ºRectangular  Starting Ypoint point coordinates
    x2   £ºRectangular  End point Xpoint coordinate
    y2   £ºRectangular  End point Ypoint coordinate
...
parameter:
    x  £ºCenter X coordinate
    y  £ºCenter Y coordinate
